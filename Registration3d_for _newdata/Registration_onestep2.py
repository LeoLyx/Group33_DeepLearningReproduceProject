...
def evaluation(config, device, df, df_with_grid):
    ...
    result_log = open("/home/leo/Documents/dp_re/NODEO-DIR/result_lambda2_5.txt", "a")
    result_dice_log = open("/home/leo/Documents/dp_re/NODEO-DIR/result_dice_lambda2_5.txt", "a") 
    print('Total of neg Jet: ', mean_neg_J)
    print('Ratio of neg Jet: ', ratio_neg_J)
    result_log.write('Total of neg Jet: ' + str(mean_neg_J) + '\n')
    result_log.write('Ratio of neg Jet: ' + str(ratio_neg_J) + '\n')
    ### Calculate Dice
    ...
    result_log.write('Avg. dice on ' + str(len(label)) + ' structures: ' + str(np.mean(dice_move2fix)) + '\n')
    result_dice_log.write(str(np.mean(dice_move2fix)) + ' ' + str(np.std(dice_move2fix)) + '\n')
    result_log.close()
    result_dice_log.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--moving", type=str,
                        dest="moving", default='./data/OASIS_OAS1_0001_MR1/aligned_norm.nii.gz',
    ...
    parser.add_argument("--moving_seg", type=str,
                        dest="moving_seg", default='./data/OASIS_OAS1_0001_MR1/aligned_seg35.nii.gz',
