...
def evaluation(config, device, df, df_with_grid):
    ...
    result_log = open("/home/leo/Documents/dp_re/NODEO-DIR/result_lambda2.txt", "a")
    result_dice_log = open("/home/leo/Documents/dp_re/NODEO-DIR/result_dice_lambda2.txt", "a") 
